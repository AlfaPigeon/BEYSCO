(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,80319,e=>{"use strict";var t=e.i(79924),o=e.i(42156),a=e.i(58882);function n(e){return(0,t.jsxs)("span",{className:`absolute -translate-x-1/2 flex-col items-center gap-1.5 ${e.hideOnMobile?"hidden md:flex":"flex"}`,style:{left:e.left,top:e.top},children:[(0,t.jsx)("span",{"aria-hidden":"true",className:"h-3 w-px bg-neutral-900"}),(0,t.jsx)("span",{className:"text-[0.625rem] font-medium tracking-wide text-neutral-700 uppercase",children:e.label})]},e.id)}e.s(["default",0,e=>{let i,r,s,l,c,u,d,h=(0,o.c)(14),{stops:f}=e,m=(0,a.useRef)(null),[g,p]=(0,a.useState)(!1);h[0]===Symbol.for("react.memo_cache_sentinel")?(i=()=>{let e=m.current;if(!e)return;let t=new IntersectionObserver(e=>{let[o]=e;o.isIntersecting&&(p(!0),t.disconnect())},{rootMargin:"-15% 0px"});return t.observe(e),()=>t.disconnect()},r=[],h[0]=i,h[1]=r):(i=h[0],r=h[1]),(0,a.useEffect)(i,r);let b=+!g;h[2]!==b?(s=(0,t.jsx)("path",{className:"ease-snap stroke-blue-600 transition-[stroke-dashoffset] duration-[900ms] [stroke-dasharray:1] motion-reduce:transition-none",d:"M0 60 C 120 48, 200 38, 300 44 C 400 50, 470 30, 600 36",pathLength:1,strokeWidth:2,style:{strokeDashoffset:b}}),h[2]=b,h[3]=s):s=h[3];let _=+!g;return h[4]!==_?(l=(0,t.jsx)("path",{className:"ease-snap stroke-blue-200 transition-[stroke-dashoffset] duration-[900ms] [stroke-dasharray:1] motion-reduce:transition-none",d:"M0 68 C 120 56, 200 46, 300 52 C 400 58, 470 38, 600 44",pathLength:1,strokeWidth:1,style:{strokeDashoffset:_,transitionDelay:"150ms"}}),h[4]=_,h[5]=l):l=h[5],h[6]!==s||h[7]!==l?(c=(0,t.jsxs)("svg",{"aria-hidden":"true",className:"absolute inset-0 h-full w-full",fill:"none",preserveAspectRatio:"none",viewBox:"0 0 600 100",children:[s,l]}),h[6]=s,h[7]=l,h[8]=c):c=h[8],h[9]!==f?(u=f.map(n),h[9]=f,h[10]=u):u=h[10],h[11]!==c||h[12]!==u?(d=(0,t.jsxs)("div",{className:"relative mt-12 h-24 md:h-28",ref:m,children:[c,u]}),h[11]=c,h[12]=u,h[13]=d):d=h[13],d}])},10440,e=>{"use strict";var t=e.i(79924),o=e.i(42156),a=e.i(58882);let n=[[20,.09,268],[38,.22,266],[50.1,.28,263.8],[70.7,.165,254.6],[86,.12,205]],i=e=>Math.min(1,Math.max(0,e)),r=([e,t,o])=>{let a=e/100,n=o*Math.PI/180,r=t*Math.cos(n),s=t*Math.sin(n),l=(a+.3963377774*r+.2158037573*s)**3,c=(a-.1055613458*r-.0638541728*s)**3,u=(a-.0894841775*r-1.291485548*s)**3;return[i(4.0767416621*l-3.3077115913*c+.2309699292*u),i(-1.2684380046*l+2.6097574011*c-.3413193965*u),i(-.0041960863*l-.7034186147*c+1.707614701*u)]},s=`#version 300 es
in vec2 a_position;
...
`,c=new Float32Array([-1,-1,3,-1,-1,3]),u=(e,t)=>{},d=(e,t,o)=>{let a=e.createShader(t);return a?(e.shaderSource(a,o),e.compileShader(a),e.getShaderParameter(a,e.COMPILE_STATUS))?a:(u(t===e.VERTEX_SHADER?"vertex shader":"fragment shader",e.getShaderInfoLog(a)),e.deleteShader(a),null):null};e.s(["default",0,e=>{let i,h,f,m=(0,o.c)(4),{config:g}=e,p=(0,a.useRef)(null);return m[0]!==g?(i=()=>{let e=p.current;if(!e)return;let t=e.getContext("webgl2",{alpha:!0,antialias:!1});if(!t)return;let o=(e=>{let t=d(e,e.VERTEX_SHADER,s),o=d(e,e.FRAGMENT_SHADER,l);if(!(t&&o))return null;let a=e.createProgram();return(e.attachShader(a,t),e.attachShader(a,o),e.bindAttribLocation(a,0,"a_position"),e.linkProgram(a),e.deleteShader(t),e.deleteShader(o),e.getProgramParameter(a,e.LINK_STATUS))?(e.useProgram(a),a):(u("program link",e.getProgramInfoLog(a)),e.deleteProgram(a),null)})(t);if(!o)return;let a=t.createBuffer();t.bindBuffer(t.ARRAY_BUFFER,a),t.bufferData(t.ARRAY_BUFFER,c,t.STATIC_DRAW),t.enableVertexAttribArray(0),t.vertexAttribPointer(0,2,t.FLOAT,!1,0,0),t.clearColor(0,0,0,0);let i=t.getUniformLocation(o,"u_resolution"),h=t.getUniformLocation(o,"u_time"),{bandHeight:f,bandHeightRight:m,bandWidth:b,bands:_,bloom:v,ceiling:x,damp:w,density:A,palette:S,speed:R,spread:T}=((e={})=>({bandHeight:e.bandHeight??.1,bandHeightRight:e.bandHeightRight??e.bandHeight??.1,bandWidth:e.bandWidth??.05,bands:e.bands??3,bloom:e.bloom??.17,ceiling:e.ceiling??.35,damp:e.damp,density:e.density??1.6,palette:e.palette??n,speed:e.speed??.4,spread:e.spread??1}))(g);for(let[e,a]of S.entries())t.uniform3fv(t.getUniformLocation(o,`u_color${e}`),r(a));t.uniform1f(t.getUniformLocation(o,"u_bands"),_),t.uniform1f(t.getUniformLocation(o,"u_bandWidth"),b),t.uniform1f(t.getUniformLocation(o,"u_bandHeight"),f),t.uniform1f(t.getUniformLocation(o,"u_bandHeightRight"),m),t.uniform1f(t.getUniformLocation(o,"u_ceiling"),x),t.uniform1f(t.getUniformLocation(o,"u_spread"),T),t.uniform1f(t.getUniformLocation(o,"u_density"),A),t.uniform1f(t.getUniformLocation(o,"u_bloom"),v),t.uniform4f(t.getUniformLocation(o,"u_damp"),w?.x??.5,w?.y??.5,w?.radiusX??1,w?.radiusY??1),t.uniform1f(t.getUniformLocation(o,"u_dampStrength"),w?.strength??0);let y=0,E=0,L=0,P=0,I=!1,C=!0,N=()=>{let o,a,n;o=Math.min(window.devicePixelRatio||1,2),a=Math.max(1,Math.round(e.clientWidth*o)),n=Math.max(1,Math.round(e.clientHeight*o)),(e.width!==a||e.height!==n)&&(e.width=a,e.height=n),t.viewport(0,0,a,n),t.uniform2f(i,a,n),t.clear(t.COLOR_BUFFER_BIT),t.uniform1f(h,y),t.drawArrays(t.TRIANGLES,0,3)},O=e=>{P=requestAnimationFrame(O);let t=e/1e3,o=0===E?0:Math.min(.05,t-E);E=t,y+=o*R,(L+=1)%2==0&&N()},H=()=>{I&&(I=!1,cancelAnimationFrame(P))},U=window.matchMedia("(prefers-reduced-motion: reduce)"),W=()=>{U.matches||document.hidden||!C?H():I||(I=!0,E=0,P=requestAnimationFrame(O))},F=new IntersectionObserver(e=>{let[t]=e;C=t.isIntersecting,W()},{rootMargin:"20px"});F.observe(e),N();let M=new ResizeObserver(()=>{I||N()});return M.observe(e),document.addEventListener("visibilitychange",W),U.addEventListener("change",W),W(),()=>{H(),F.disconnect(),M.disconnect(),document.removeEventListener("visibilitychange",W),U.removeEventListener("change",W),t.deleteBuffer(a),t.deleteProgram(o),e.isConnected||t.getExtension("WEBGL_lose_context")?.loseContext()}},h=[g],m[0]=g,m[1]=i,m[2]=h):(i=m[1],h=m[2]),(0,a.useEffect)(i,h),m[3]===Symbol.for("react.memo_cache_sentinel")?(f=(0,t.jsx)("canvas",{"aria-hidden":"true",className:"pointer-events-none absolute -top-[2%] -left-[10%] z-10 block h-[104%] w-[120%]",ref:p}),m[3]=f):f=m[3],f}],10440)}]);